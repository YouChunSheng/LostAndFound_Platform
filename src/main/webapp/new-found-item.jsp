        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center">发布招领信息</h3>
                </div>
                <div class="card-body">
                    ...
                    <form id="foundItemForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="foundTime" name="foundTime" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-grid">
                            <button type="button" class="btn btn-primary" onclick="submitFoundItemForm()">发布</button>
                        </div>
                    </form>
                </div>
            </div>
