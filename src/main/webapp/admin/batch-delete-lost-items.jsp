        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-center">批量删除失物信息</h3>
                </div>
                <div class="card-body">
...
<script>
    ...
    document.getElementById('deleteButton').addEventListener('click', function() {
        ...
        if (!confirm(`确定要删除选中的 ${selectedIds.length} 项失物信息吗？此操作不可恢复！`)) {
            return;
        }
        
        const ids = Array.from(selectedIds).map(cb => cb.value);
        
        fetch('<%=request.getContextPath()%>/admin/batch-delete-lost-items', {
            method: 'POST',
            headers: {
